...
const NavItems: React.FC<NavItemProps> = ({isOpen, handleToggle}) => {
    ...
    return (
        <>
            ...
            <li onClick={handleClick} className="md:py-8 tracking-widest cursor-pointer border-r-4 md:border-b-4 border-tropicalBlue border-opacity-0 hover:border-white transition ease-in-out delay-75">
